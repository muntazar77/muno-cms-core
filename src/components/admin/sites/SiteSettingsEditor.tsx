...
export default function SiteSettingsEditor({
  ...
  return (
    <div className="min-h-screen bg-[var(--cms-bg-elevated)] text-[var(--cms-text)]">
      {/* ── Compact Header ──────────────────────────────────────── */}
      <div className="sticky top-0 z-10 border-b border-[var(--cms-border-subtle)] bg-[var(--cms-card-bg)] px-6 py-4">
        <div className="flex items-center justify-between gap-4">
          <div>
            <h1 className="text-xl font-semibold tracking-tight text-[var(--cms-text)]">
              Site Settings
            </h1>
            <p className="mt-0.5 text-sm text-[var(--cms-text-secondary)]">
              {formState.siteName || formState.siteId} &middot;{' '}
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              onClick={handleSave}
              disabled={isSaving}
              className="inline-flex h-9 items-center gap-2 rounded-lg bg-[var(--cms-primary)] px-4 text-sm font-semibold text-white transition hover:bg-[var(--cms-primary-hover)] disabled:cursor-not-allowed disabled:opacity-60"
            >
              {isSaving ? (
      ...
      <div className="flex min-h-[calc(100vh-65px)]">
        {/* Left Sidebar */}
        <aside className="w-56 shrink-0 border-r border-[var(--cms-border-subtle)] bg-[var(--cms-card-bg)] p-4">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isActive
                      ...
                      : 'text-[var(--cms-text-secondary)] hover:bg-[var(--cms-bg-muted)] hover:text-[var(--cms-text)]',
                  )}
                >
          ...
          {canEditOwner && (
            <div className="mt-6 border-t border-[var(--cms-border-subtle)] pt-4">
              <p className="mb-2 px-3 text-[10px] font-semibold uppercase tracking-widest text-[var(--cms-text-muted)]">
                Danger Zone
              </p>
              <button
                type="button"
                ...
                className="flex w-full items-center gap-2.5 rounded-lg px-3 py-2.5 text-left text-[13px] font-medium text-[var(--cms-danger-text)] transition hover:bg-[var(--cms-danger-soft)] disabled:opacity-60"
              >
